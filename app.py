    ...
    def homepage():
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function displaySingleResult(result) {
                ...
                // Create result HTML with a simpler, cleaner layout
                let resultHTML = `
                    <div class="p-4 bg-base-200 rounded-lg mb-4">
                        <!-- Input image thumbnail in a simple row at the top -->
                        <div class="flex items-center justify-center mb-4 p-2 bg-base-300 rounded-lg">
                            <img 
            ...
            function displayBatchCarousel(batchResult) {
                ...
                // Get references to the preview images
                const previewImages = [];
                const previewItems = batchPreviewsContainer.querySelectorAll('.preview-item');
                ...
                batchResult.results.forEach((result, index) => {
                    // Get the corresponding preview image (if available)
                    const previewSrc = index < previewImages.length ? previewImages[index] : '';
                    ...
                    // Create the carousel item with a simpler layout
                    ...
                    carouselItem.innerHTML = `
                        <div class="w-full px-4 py-6 bg-base-200 rounded-lg">
                            <div class="w-full max-w-3xl mx-auto">
                                ...
                                <!-- Input image thumbnail in a simple row -->
                                <div class="flex items-center justify-center my-4 p-2 bg-base-300 rounded-lg">
                                    ${previewSrc ? 
                                        `<img src="${previewSrc}" 
                                            alt="Input Image ${index + 1}" 
                                            class="max-h-40 object-contain rounded">` :
                                        `<div class="h-40 w-full flex items-center justify-center text-base-content/50">
