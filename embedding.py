...
# NOTE!
# Need to manually upload pdf into a volume and a folder called uploaded_pdfs:
# modal volume put target_volume target_doc.pdf uploaded_pdfs/ 
# then run embedding.py:
# modal run embedding.py

# Constants and directories - Updated to match app.py
DATA_DIR = "/data"
UPLOADED_PDFS_DIR = "/data/uploaded_pdfs"
...
# Define app with the same name as in app.py
app = modal.App("bee_classifier_rag")

# Look up data volume for storing results - using same volume as the main app
try:
...
def main(command="process", pdf_path=None):
    if command == "process":
        ...
        print("Usage:")
        print("  python embedding_colpali.py process")
        print("  python embedding_colpali.py upload /path/to/your.pdf")
